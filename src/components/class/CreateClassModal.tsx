...
interface Props {
  open: boolean;
  onClose: () => void;
  onCreate: (classDetails: ClassDetails) => Promise<void> | void;
}

export default function CreateClassModal({ open, onClose, onCreate }: Props) {
  const [formData, setFormData] = useState<ClassDetails>({
    name: "",
    section: "",
    subject: "",
    room: "",
  ...
  return (
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <Typography
          id="create-class-modal-description"
